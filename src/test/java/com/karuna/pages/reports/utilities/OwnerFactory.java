...
public class OwnerFactory {
    ...
    public Listing stubListing() {
        ...
        List<Role> roleList = new ArrayList<>();
        roleList.add(role);
        Listing listing = new Listing(1L, "Jefferson", 1, "someAddress", 123.2, 321.1, "banner.png", "icon.png", 0, 4, stubUser(), stubCategory2(), null);
    ...
    public Listing stubListing1() {
        ...
        Listing listing = new Listing(1L, "Jefferson", 1, "someAddress", 123.2, 321.1, "banner.png", "icon.png", 0, 2, stubUser(), stubCategory(), null);
    ...
    public Listing stubListing2() {
        ...
        Listing listing = new Listing(1L, "Jefferson", 1, "someAddress", 123.2, 321.1, "banner.png", "icon.png", 0, 1, stubUser(), stubCategory(), null);
    ...
    public Review stubReview1() {
        Review review = new Review(1L, "This is my comment", 4, 1, stubUser(), stubListing1());
    ...
    public Review stubReview2() {
        Review review = new Review(1L, "This is my another", 3, 1, stubUser(), stubListing1());
    ...
    public Review stubReview3() {
        Review review = new Review(1L, "This is my another again", 4, 1, stubUser2(), stubListing());
